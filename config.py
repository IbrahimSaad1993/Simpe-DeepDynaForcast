...
def get_arguments():
    ...
    data.add_argument("--ds_name", type=str, default="ddf_resp+TB_20230222")
    data.add_argument("--ds_dir", type=str, default="/media/obito/My Book/Projects/Dr_Magalis/DeepDynaForecast-main/cleaned_data")
